// Include the header file for SensorDuinoV2
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  printSensorData("\nAmbient Light Strength = ", BH1750_Luminosity_lux, " lux");
  printSensorData("\nTemperature Celsius    = ", SHT30_Temp_C, " C");
  printSensorData("\nTemperature Fahrenheit = ", SHT30_Temp_F, " F");
  printSensorData("\nRelative Humidity      = ", SHT30_Humidity_Level, "%");
  printSensorData("\nAtmospheric Pressure   = ", HP203N_Pressure_kPa, " kPa");
  printSensorData("\nSmoke   = ", MQ2_Gas_Level, " %");
  printSensorData("\nCH2O   = ", ZE08_CH2O_mgm3, "mg/m3");
  Serial.println();
...
void printSensorData(const String& sensorName, double value, const String& unit) {
  Serial.print(sensorName);
  Serial.print(": ");
  Serial.print(value, 2); // Print with two decimal places
  Serial.println(" " + unit);
}